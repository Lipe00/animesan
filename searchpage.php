                ...
                <div class="rtags">
                    ...
                    <div class="tag gen" id="sgen">
                        <div class="geno ttag" id="geno">
                            ...
                            ?>
                            <div class="teste2 thetest">Gênero: <b id="gb"><?=$resultSGen['nomeGenero']?></b></div>
                            <!-- <div class="x" id="gx">
                            ...
                            <div class="x" id="gx">
                                <form action="./searchpage.php" method="GET" enctype="multipart/form-data">
                                    ...
                                    ?>
                                    <button type="submit" id="submit-clearg" class="ltl"></button>
                                    <label for="submit-clearg" class="lab">
                                        <i class="fa-solid fa-xmark" id="gxi"></i>
                                    </label>
                                </form>
                            </div>
                            ...
                            ?>
                            <div class="teste2 thetest">Gênero: <b id="gb"><div class="des">Nenhum selecionado</div></b></div>
                            <?php
                            }
                            ?>
                    ...
                    <div class="op"> Ordenar por: 
                        <div class="ops">
                            <div class="opa" id="opa">
                                ...
                                if(!empty($order)){
                                    if($order == 1){
                                        echo "<b id=\"bo\">Ordem alfabética<i class='fa-solid fa-arrow-up'></i></b>";
                                    }elseif($order == 2){
                                        echo "<b id=\"bo\">Ordem alfabética<i class='fa-solid fa-arrow-down'></i></b>";
                                    }elseif($order == 3){
                                        echo "<b id=\"bo\">Data de lançamento<i class='fa-solid fa-arrow-up'></i></b>";
                                    }elseif($order == 4){
                                        echo "<b id=\"bo\">Data de lançamento<i class='fa-solid fa-arrow-down'></i></b>";
                                    }elseif($order == 5){
                                        echo "<b id=\"bo\">Avaliação<i class='fa-solid fa-arrow-up'></i></b>";
                                    }elseif($order == 6){
                                        echo "<b id=\"bo\">Avaliação<i class='fa-solid fa-arrow-down'></i></b>";
                                    }elseif($order == 7){
                                        echo "<b id=\"bo\">Ranking<i class='fa-solid fa-arrow-up'></i></b>";
                                    }elseif($order == 8){
                                        echo "<b id=\"bo\">Ranking (Decrescente)</b>";
                                    }
                                }else{
                                ?>
                                <b id="bo">Ordem alfabética<i class='fa-solid fa-arrow-up'></i></b>
                                <?php
                                }
                                ?>
                            ...
                            <?php
                                ...
                                <div class="opm none" id="opm">
                                    <div class="opmo">
                                        ...
                                        <label for="opm1">Ordem alfabética<i class='fa-solid fa-arrow-up'></i></label>
                                    </div>
                                    <div class="opmo">
                                        <input type="radio" name="opm" id="opm2" value="2" onchange="this.form.submit()">
                                        <label for="opm2">Ordem alfabética<i class='fa-solid fa-arrow-down'></i></label>
                                    </div>
                                    <div class="opmo">
                                        <input type="radio" name="opm" id="opm3" value="3" onchange="this.form.submit()" >
                                        <label for="opm3">Data de lançamento<i class='fa-solid fa-arrow-up'></i></label>
                                    </div>
                                    <div class="opmo">
                                        <input type="radio" name="opm" id="opm4" value="4" onchange="this.form.submit()">
                                        <label for="opm4">Data de lançamento<i class='fa-solid fa-arrow-down'></i></label>
                                    </div>
                                    <div class="opmo">
                                        <input type="radio" name="opm" id="opm5" value="5" onchange="this.form.submit()">
                                        <label for="opm5">Avaliação<i class='fa-solid fa-arrow-up'></i></label>
                                    </div>
                                    <div class="opmo">
                                        <input type="radio" name="opm" id="opm6" value="6" onchange="this.form.submit()">
                                        <label for="opm6">Avaliação<i class='fa-solid fa-arrow-down'></i></label>
                                    </div>
                                    <div class="opmo">
                                        <input type="radio" name="opm" id="opm7" value="7" onchange="this.form.submit()">
                                        <label for="opm7">Ranking<i class='fa-solid fa-arrow-up'></i></label>
                                    </div>
                                    <div class="opmo">
                                        <input type="radio" name="opm" id="opm8" value="8" onchange="this.form.submit()">
                                        <label for="opm8">Ranking<i class='fa-solid fa-arrow-down'></i></label>
                                    </div>
                                </div>
        ...
        <div class="ctags">
            ...
            <div class="ctt">
                <?php
                    ...
                    ?>
                <div class="cgen"> <!-- -->
                    <div class="tag gen" id="sgenC">
                        <div class="genoC ttag" id="genoC">
                            <?php
                            if(!empty($genero)){
                                $sqlSGen = "SELECT * FROM `genero` WHERE idGenero=:genAtual LIMIT 1";
                                $selectSGen = $conexao->prepare($sqlSGen);
                            ...
                            ?>
                            <div class="teste2 thetestC">Gênero: <b id="gbC"><?=$resultSGen['nomeGenero']?></b></div>
                            <div class="x" id="gx">
                                <form action="./searchpage.php" method="GET" enctype="multipart/form-data">
                                    <?php
                                    if(!empty($pesquisa)){
                            ...
                            ?>
                            <div class="teste2 thetestC">Gênero: <b id="gbC"><div class="des">Nenhum</div></b></div>
                            <?php
                            }
                            ?>
                            <!-- Gênero: <b id="gb">"Nenhum selecionado"</b> -->
                        ...
                        <div class="gens none" id="gensC">
                            
                                <?php
                                    foreach($resultGen as $gen_row){
                                ?>
                                <form action="./searchpage.php" id="formGenC" method="GET" enctype="multipart/form-data">
                                    <div class="geni" id="geniC">
                                        <?php
                                        if(!empty($pesquisa)){
                                        ?>
                                        <input type="hidden" name="busca" value ="<?=$pesquisa?>">
            ...
            <div class="cop">
                <form action="./searchpage.php" id="formOrderC"method="GET" enctype="multipart/form-data">
                    <div class="op"> 
                        <div class="ops">
                            <div class="opa" id="opaC">
                                <?php
                                if(!empty($order)){
                                    if($order == 1){
                                        echo "<b id=\"bo\">Ordem alfabética<i class='fa-solid fa-arrow-up'></i></b>";
                                ...
                                ?>
                                <b id="boC">Ordem alfabética <i class="fa-solid fa-arrow-up"></i></b>
                                <?php
                                }
                                ?>
                                <i class="fa-solid fa-chevron-down" id="arrowC"></i>
                            </div>
                            <?php
                                if(!empty($pesquisa)){
                                ?>
