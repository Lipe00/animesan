            ...
            <div class="l-menu">
                ...
                <div class="info">
                    ...
                    <p><b>Gênero:</b>
                        ...
                        ?>
                        <a href="./search?genero=<?=$gen1Res['idGenero'];?>">
                        <?php
                        ...
                        ?>
                        <a href="./search?genero=<?=$gen2Res['idGenero'];?>">
                        <?php
                        ...
                        ?>
                        <a href="./search?genero=<?=$gen3Res['idGenero'];?>">
                        <?php
                        ...
                        ?>
                        <a href="./search?genero=<?=$gen4Res['idGenero'];?>">
                        <?php
                        ...
                        ?>
                        <a href="./search?genero=<?=$gen5Res['idGenero'];?>">
                        <?php
            ...
            <div class="r-menu">
                ...
                <div class="comments">
                    ...
                    <div class="comment">
                        <div class="c1">
                            <div class="u1">
                                <img src="<?=$resultComUser['fotoUser']?>">
                                <p><?=$resultComUser['nomeUser']?>)</p>
                                <div class="rating">
                            ...
                            if($totalResp != 0){
                                foreach($resultResp as $resposta){
                            ...
                            ?>
                                <div class="resposta">
                                    <div class="c1">
                                        <div class="u1">
                                            <img src="<?=$resultRespUser['fotoUser']?>">
                                            <p><?=$resultRespUser['nomeUser']?></p>
                                        </div>
                                        <div class="msg">
                                            <?= $resposta['textoResp']?>
                                        </div>
