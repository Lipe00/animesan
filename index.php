...
<body id="body">
    <div class="space">
        ...
        <?php
        include_once("./index-ranking.php");
        if($total != 0){
        ...
        <div class="align">
            <div class="container">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        ...
                                        <div class="a-info">
                                            ...
                                            <b>Ranking:</b><p>#<?=$linha['rankingAnime'];?></p>
                                            <b>Gêneros:</b>
                                            <p>
                ...
                <div class="swiper-button-next swiper-navBtn right"></div>
                <div class="swiper-button-prev swiper-navBtn left"></div>
            </div>
        </div>
        <?php
        }
        ...
        if($total != 0){
            $sql = "SELECT * FROM animes ORDER BY rankingAnime";
            $select = $conexao->query($sql);
            $resultR = $select->fetchAll();
            $total = $select->rowCount();
        ?>

        <div class="categoria"><a href="./searchpage.php?opm=8">Ranking <i class="fa-solid fa-arrow-right"></i></a> </div>
        <div class="align">
            <div class="container">
                <div class="content">
                    <div class="swiper mySwiper-S32">
                        <div class="slider swiper-wrapper">
                            <?php
                            foreach($resultR as $linha){
                                $urlAni = $linha['idAnime'];
                ...
                <div class="swiper-button-next-32 swiper-navBtn right"></div>
                <div class="swiper-button-prev-32 swiper-navBtn left"></div>
            </div>
        </div>
        <?php
        }
        ...
        <div class="align">
            <div class="container">
                ...
                <div class="swiper-button-next-<?=$rows_gen['idGenero']?> swiper-navBtn right"></div>
                <div class="swiper-button-prev-<?=$rows_gen['idGenero']?> swiper-navBtn left"></div>
            </div>
        </div>
        <?php
                }
